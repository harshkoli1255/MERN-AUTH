...
const SignUp = () => {
    ...
    const { signup, error, isLoading, user} = userAuthStore();
    ...
    const handleSignup = async (e) => {
        ...
        try {
            ...
            toast.success("Verification link has been set to your email...")
        } catch(error) {
            console.log(error);
        }
    }
  ...
  return (
    ...
    <div className='p-8'>
        <h2 className="text-3xl font-bold mb-6 text-center bg-gradient-to-r from-cyan-300 via-violet-300 to-fuchsia-300 text-transparent bg-clip-text">Create an Account</h2>
        ...
        <form onSubmit={(e) => handleSignup(e)}>
            ...
            {error && <p className='text-red-500 font-semibold mt-2 mx-auto'>{error}</p>}
            ...
            >
                ...
                {isLoading ? <Loader className='w-6 h-6 animate-spin mx-auto'/> : <span>Sign Up</span>}
